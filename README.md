...
当前纯 CLI 与系统服务版本为 [v0.9.7 预发布](https://github.com/isarmg/host-monitoring-client/releases/tag/v0.9.7)；用法和验收限制见 [CLI 改造说明](docs/releases/cli-unreleased.md)。安装产物未签名、未公证，实机与升级验收边界见发行说明。
